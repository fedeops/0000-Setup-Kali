# Generated by Powerlevel10k configuration wizard on 2026-01-31 at 19:13 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_{STAGED,UNSTAGED,UNTRACKED,CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND}_VISUAL_IDENTIFIER_EXPANSION=
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_CONTENT_EXPANSION='${P9K_CONTENT:0:24}${${P9K_CONTENT:25}:+…}'
  ...
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_PROJECT_NAME//\%/%%} ${P9K_GCLOUD_REGION//\%/%%}'
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%70F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%70F⇡$P9K_IP_TX_RATE}'
